-- ═══════════════════════════════════════════════════════════
-- HUBBLE — Migration: Fix RPC get_user_stats enum 'reading'
-- Remove referência inválida a 'reading' no enum user_status_enum
-- Valores válidos: planning, watching, paused, completed, dropped, rewatching
...
SELECT 'RPC get_user_stats corrigido (enum reading removido)!' AS status;